...
function Work() {
  return (
    <div className='lg:w-[85%]   w-[90%] md:mt-[6%] mt-[8%]   mx-auto lg:mt-[3%]'>
        {/* heading div  */}
        <div>
            <h1 className='md:text-[36px] text-[24px] flex md:justify-start justify-center font-medium'>How Mybabu works?</h1>
        </div>
        {/* grid-4 div  */}
        <div className='lg:grid-cols-4 w-full border border-black  gap-y-10 md:grid-cols-2 grid-cols-1 grid mt-[2%] gap-x-[1%]'>
            ...
            <div className='border '>
              ...
              <div className=''>
              <p className='text-[14px] md:w-full w-[60%] border md:ml-0 ml-[25%] md:mt-0 mt-3 font-normal lg:pl-[16%] md:pt-2'>Fill out simple online form describing your needs.Our Intutive Interface ensures  that you provide all the neccessary details right away.</p>
              </div>
              </div>
